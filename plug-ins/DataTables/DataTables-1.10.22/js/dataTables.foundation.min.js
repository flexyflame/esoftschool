...
{sWrapper:"dataTables_wrapper dt-foundation",sProcessing:"dataTables_processing panel callout"});b.extend(!0,k.defaults,{dom:"<'row grid-x'<'small-12 medium-6 large-6 columns limit-cover cell'l><'small-12 medium-6 large-6 columns search-cover cell'f>r>t<'row grid-x'<'small-12 medium-6 large-6 columns limit-cover cell'i><'small-12 medium-6 large-6 search-cover-cover columns cell'p>>",renderer:"foundation"});k.ext.renderer.pageButton.foundation=function(g,x,y,z,d,m){var r=new k.Api(g),A=g.oClasses,n=g.oLanguage.oPaginate,B=g.oLanguage.oAria.paginate||{},e,h,f,C=5===k.ext.foundationVersion,w=function(t,u){var v,D=function(p){p.preventDefault();
