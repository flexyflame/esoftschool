                    ...
                    <tbody>
                        <?php
                            foreach ($query_result_array as $obj) {
                                ...
                                echo "          <input type=\"number\" class=\"input_result_entry\" id=\"text_cum100_" . $obj->id . "\" oninput=\"cum100_onInput(" . $obj->id . ");\" tabindex=\"1\" min=\"0\" max=\"100\" value=\"" . $obj->cum100 . "\" />";
                                echo "     </div>"; 
                                echo "  </td>";
                                ...
                                echo "     </div>";   
                                echo "     <div>";
                                echo "          <input type=\"number\" class=\"input_result_entry text_testresult\" id=\"text_testresult_" . $obj->id . "\" tabindex=\"2\" min=\"0\" max=\"" . $obj->test . "\" value=\"" . $obj->Testresult . "\" />";
                                echo "     </div>"; 
                                echo "  </td>";
                                ...
                                echo "          <input type=\"number\" class=\"input_result_entry\" id=\"text_exam100_" . $obj->id . "\" tabindex=\"1\" min=\"0\" max=\"100\" value=\"" . $obj->exam100 . "\" />";
                                echo "     </div>"; 
                                echo "  </td>";
                                ...
                                echo "     </div>";   
                                echo "     <div>";
                                echo "          <input type=\"number\" class=\"input_result_entry text_examresult\" id=\"text_examresult_" . $obj->id . "\" tabindex=\"4\" min=\"0\" max=\"" . $obj->exam . "\" value=\"" . $obj->examresult . "\" />";
                                echo "     </div>"; 
                                echo "  </td>";
...
<script type="text/javascript">
    ...
    function cum100_onInput(var_id) {
        ...
        var cum100 = document.getElementById("text_cum100_" + var_id);
        var test = "33";//document.getElementById("val_test_" + var_id).innerHTML;

alert(test + " : " + Number.parseFloat(testresult.value));

        //testresult.value = cum100.value * test.testcontent / 100;
    }
