      ...
      DB_Close($dbconn);
        ...
        echo "<tbody>";
            ...
            foreach ($query_result_array as $obj) {
                ...
                echo "  <a style=\"margin-right: 10px;\" href=\"" . $SESSION->Generate_Link("subjectgradeset_overview", "list_dialog_aktion=subjectgrade_delete&SubjectgradeID=" . $obj->SubjectgradeID . "") . "\"><i class=\"fa fa-trash action-controls\" title=\"Delete Record\"></i> </a>";
